...
export const ApplicationCard = ({ application, onUpdate, isSelected = false, onContinueApplying }: ApplicationCardProps) => {
  ...
  const getStatusColor = (status: string) => {
    const colors: { [key: string]: string } = {
      ...
      'Interview Result Awaited': 'bg-gradient-to-r from-orange-100 to-orange-200 text-orange-800 dark:from-orange-900/40 dark:to-orange-800/40 dark:text-orange-300',
  ...
  const getStatusBorderColor = (status: string) => {
    const colors: { [key: string]: string } = {
      ...
      Interview: '#a855f7',
      'Interview Result Awaited': '#f97316',
